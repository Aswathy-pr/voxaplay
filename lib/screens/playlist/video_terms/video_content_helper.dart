...
import 'package:musicvoxaplay/screens/models/video_models.dart';
import 'package:musicvoxaplay/screens/playlist/video_terms/video_playlist_creation_helper.dart';
import 'package:musicvoxaplay/screens/playlist/video_terms/video_playlist_delete_helper.dart';
import 'package:musicvoxaplay/screens/playlist/video_terms/video_playlist_migration_helper.dart';
import 'package:musicvoxaplay/screens/playlist/video_terms/video_playlist_rename_helper.dart';
import 'package:musicvoxaplay/screens/playlist/video_terms/video_navigation_helper.dart';

class VideoContentHelper {
  static Future<void> migrateOldPlaylistFormat(Box playlistVideosBox) async {
    await VideoPlaylistMigrationHelper.migrateOldPlaylistFormat(playlistVideosBox);
  }

  static void navigateTo(BuildContext context, Widget page) {
    VideoNavigationHelper.navigateTo(context, page);
  }
  ...
  static void navigateToPlaylist(
    ...
    VideoNavigationHelper.navigateToPlaylist(context, playlistName, playlistVideosBox);
  }
  ...
  static Future<void> handleCreatePlaylist(
    ...
    await VideoPlaylistCreationHelper.handleCreatePlaylist(context, playlistsBox, playlistVideosBox, currentVideo);
  }
  ...
  static Future<void> handleRenamePlaylist(
    ...
    await VideoPlaylistRenameHelper.handleRenamePlaylist(context, playlistsBox, playlistVideosBox, onRefresh: onRefresh);
  }
  ...
  static Future<void> handleDeletePlaylist(
    ...
    await VideoPlaylistDeleteHelper.handleDeletePlaylist(context, playlistsBox, playlistVideosBox, onRefresh: onRefresh);
  }
}